...
(function() {
    // Stone stypes
    JGO.CLEAR = 0; // no stone
    JGO.BLACK = 1; // black stone
    JGO.WHITE = 2; // white stone
    JGO.DIM_BLACK = 3; // semi-transparent black stone
    JGO.DIM_WHITE = 4; // semi-transparent white stone
